...
const (
	...
	ChannelTypeCodex          = 57
	ChannelTypePixverse       = 58
	ChannelTypeBytePlusVideo  = 59
...
var ChannelBaseURLs = []string{
	...
	"https://app-api.pixverse.ai",               //58
	"https://ark.ap-southeast.bytepluses.com",   //59
}
...
var ChannelTypeNames = map[int]string{
	...
	ChannelTypeBytePlusVideo:  "BytePlusVideo",
}
